                                ...
                                <div class="d-flex order-lg-2">
                                    ...
                                    <div class="dropdown d-md-flex profile-1">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                            ...
                                            <a class="dropdown-item" href="javascript: void(0);" onclick="event.preventDefault();document.querySelector('.adminLogout').submit();">
                                            ...
                                            <form action="{{route('logout')}}" method="POST" class="adminLogout">@csrf</form>
                                        </div>
                                    </div>
                                    <!-- Profile -->
                                </div>
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a href="{{route('category.manage')}}" class="slide-item">Manage Catetgory</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Subcategory Module</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li><a href="{{route('subcategory.add')}}" class="slide-item">Add Subcategory</a></li>
                                <li><a href="{{route('subcategory.manage')}}" class="slide-item">Manage Subcategory</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <ul class="slide-menu">
                                <li><a href="chart-morris.html" class="slide-item">Add Brand</a></li>
                                <li><a href="chart-nvd3.html" class="slide-item">Manage Brand</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <ul class="slide-menu">
                                <li><a href="icons9.html" class="slide-item">Add Unit</a></li>
                                <li><a href="icons10.html" class="slide-item">Manage Unit</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <ul class="slide-menu">
                                <li><a href="maps2.html" class="slide-item">Add Product</a></li>
                                <li><a href="maps.html" class="slide-item">Manage Product</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="typography.html" class="slide-item">Manage Customer</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <ul class="slide-menu">
                                <li><a href="users-list.html" class="slide-item">Add User</a></li>
                                <li><a href="file-attachments.html" class="slide-item">Manage User</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <ul class="slide-menu">
                                <li><a href="faq.html" class="slide-item">Manage Company</a></li>
                                <li><a href="pricing.html" class="slide-item">Manage Offer</a></li>
                            </ul>
                        </li>
                    </ul>
